...
export const MobileBottomNav: React.FC = () => {
  ...
  return (
    <div className="xl:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-slate-200 shadow-[0_-4px_12px_rgba(0,0,0,0.05)] px-1 py-1.5 flex items-center justify-around">
        ...
        return (
          <Link
            ...
            className={`flex flex-col items-center gap-0.5 py-1 px-2 rounded-xl transition-all duration-200 ${
              isActive
                ? "text-blue-700 scale-105 font-bold"
